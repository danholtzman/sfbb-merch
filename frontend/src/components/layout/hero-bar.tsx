  ...
  return (
    <section className="bg-primary p-8 h-48 flex items-center place-content-between shrink-0">
      <div>
        ...
        <span className="text-sm font-mono px-4 py-2 border rounded-full -m-1 bg-destructive/50 border-destructive text-destructive">
          <span className="mr-2 text-destructive">●</span>
          <span className="text-red-200">Ordering closes March 15, 2025</span>
        </span>
      </div>
